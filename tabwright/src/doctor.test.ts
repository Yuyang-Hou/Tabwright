...
describe('buildDoctorReport', () => {
  ...
  test('asks for the extension click before suggesting a headless fallback', () => {
    ...
    expect(report.next.title).toContain('click the Tabwright extension icon')
    expect(report.next.fallbackCommand).toBe('tabwright session new --browser headless')
  })
  ...
  test('explains a newer extension and missing relay', () => {
    ...
    expect(report.next.command).toBe('tabwright logfile')
  })
