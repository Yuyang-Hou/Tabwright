...
Cloud browsers appear alongside your local Chrome in `tabwright session new`, so your existing
...
# Japanese proxy
tabwright session new --browser cloud --proxy jp
```
...
{
  "env": {
    "TABWRIGHT_CLOUD_TOKEN": "your-token"
  }
}
```
