---
title: Remote Access
description: Control a Chrome browser on any machine from anywhere over the internet using tabwright serve and traforo tunnels.
icon: lucide:globe
---
...
1. Install [Tabwright from the Chrome Web Store](https://chromewebstore.google.com/detail/tabwright/dkfhphbajbkplddmchbdgdddioonngep)
...
│  HOST MACHINE                                                                          │
│                                                                                        │
│  Chrome + Extension ◄────── local WS ──────► tabwright serve :19988                   │
└───────────────────────────────────────────────────────▲────────────────────────────────┘
                                                        │
...
**Step 2: Docker.** Set `TABWRIGHT_HOST` in your container:
