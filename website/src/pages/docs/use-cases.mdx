---
title: Use Cases
description: Practical examples of what you can do with Tabwright, from QA testing to task automation.
icon: lucide:lightbulb
---

Tabwright gives agents and scripts access to your **real Chrome browser** with all your logins, extensions, and cookies. Here are some things people use it for.
