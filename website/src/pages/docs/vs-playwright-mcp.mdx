...
Tabwright connects to your **running Chrome** instead. Same browser you're already using,
...
Tabwright runs in your existing Chrome session. Your cookies, extensions, and browsing
...
# Tabwright: agent works in your browser, you collaborate in real time

tabwright session new
tabwright -s 1 -e "page.goto('https://gmail.com')"
