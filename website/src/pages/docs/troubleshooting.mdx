...
This checks the relay, extension version, enabled tabs, sessions, and visible capabilities. Follow the single `Next` action it prints before manually restarting processes. For agent or support automation, use `playwriter doctor --json`.
